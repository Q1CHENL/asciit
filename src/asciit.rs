...
fn main() {
    ...
    for argument in args {
        match argument.as_str() {
            ...
            "--help" => {
                println!("Usage: ");
                println!("ascii h: print the horizontal table (16 x 8) (default)");
                println!("ascii v: print the vertical table (32 x 4)");
                println!("ascii --help: print this help message");
                exit(0);
            }
            &_ => {
                eprintln!("{} {}", "Wrong argument: ", argument);
                exit(1)
            }
        }
    }
